...
- Hero: product mark, version 1.3.0, one-sentence purpose, Install anchor, and Source link.
- What it does: three static steps covering selection, read-only challenge, and disposition.
- Install: three commands in one horizontally scrollable code block.
- Compatibility: four facts covering supported Codex surfaces, absent services,
  and the Standard and Specialist roles.
...
Reduced-motion mode disables the cursor and hover motion.

## Candidate verification

- `npm test`: 40 Playwright checks passed in desktop Chromium and iPhone 13 WebKit profiles.
