...
- Hero: version 1.3.4, one-sentence purpose, Install anchor, and Source link. It starts at the shared content edge with no standalone product icon or cursor animation.
